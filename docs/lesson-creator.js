...
function draftFromPack(pack, snapshot) {
  pack = includeLessonIllustrations(pack);
...
export function createLessonStudio({ store, download, showToast, getSnapshot, openFilePicker, openFolderPicker = () => {}, openAssetPicker = () => {}, publishToDepot = () => {} }) {
  ...
  const setField = (path, value, target) => {
    ...
    if (path === "draft.subjectMode" && value === "create" && draft.subjectId === "SUBJECT_MATH") {
      draft.subjectId = "SUBJECT_MY_SUBJECT"; draft.subjectName = "My field"; draft.subjectShortName = "Field";
      ...
      <section class="studio-grid">
        ...
        <div class="studio-canvas">
          <section class="studio-card">
            <div class="studio-section-title"><div><p class="eyebrow">1 · Field</p><h2>${draft.mode === "override" ? "Native lesson location" : "Where does this set live?"}</h2></div></div>
