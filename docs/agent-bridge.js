import { createQuickMathsStore } from "./challenge-core.js?v=20260902-security-v1";
import { registerWebMcpTools, TOOL_NAMES } from "./webmcp-tools.js?v=20260902-security-v1";
import { createLessonDepot } from "./lesson-depot.js?v=20260902-security-v1";
import {
...
async function boot() {
  const [curriculumResponse, geographyResponse, manifestResponse, educatorManifestResponse, authoringGuideResponse] = await Promise.all([
    ...
    fetch("./agent-manifest.json?v=20260902-security-v1").catch(() => null),
    fetch("./educator-agent-manifest.json?v=20260902-security-v1").catch(() => null),
    fetch("./CUSTOM_LESSON_SETS.md?v=20260902-security-v1").catch(() => null),
  ]);
