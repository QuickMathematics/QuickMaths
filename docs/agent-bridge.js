import { createQuickMathsStore } from "./challenge-core.js?v=20260906-merge-v2";
...
import { BRIDGE_TOOL_NAMES, registerBridgeWebMcpTools } from "./bridge-webmcp-tools.js?v=20260906-merge-v2";
import {
  createLocalBridgeCredentialStore,
  createLocalGitContentsClient,
  resolveLocalBridgeCapability,
} from "./local-git-client.js?v=20260906-merge-v2";
