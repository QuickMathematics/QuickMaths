import { createQuickMathsStore } from "./challenge-core.js?v=20260906-app-audit-v2";
...
import { BRIDGE_TOOL_NAMES, registerBridgeWebMcpTools } from "./bridge-webmcp-tools.js?v=20260906-app-audit-v2";
import {
  createLocalBridgeCredentialStore,
  createLocalGitContentsClient,
  resolveLocalBridgeCapability,
} from "./local-git-client.js?v=20260906-app-audit-v2";
...
async function boot() {
  const [curriculumResponse, geographyResponse, manifestResponse, authoringGuideResponse, learnerManualResponse, educatorManualResponse] = await Promise.all([
    fetch("./curriculum-data.json?v=20260906-app-audit-v2"),
    fetch("./lesson-depot/lessons/geography/1.0.0/lesson-set.json?v=20260906-app-audit-v2"),
