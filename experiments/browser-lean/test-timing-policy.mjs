...
test('slow timing is bounded and selects exactly twelve known cases',()=>{assert.equal(timingBudget('slow',10000),120000);assert.equal(slowCases.size,12);assert.ok([...slowCases].every(n=>n.startsWith('series_')&&n.endsWith('.json')));});
